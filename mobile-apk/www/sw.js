const CACHE_NAME = 'mytcg-webapp-v31';
const STATIC_ASSETS = [
    '/webapp/',
    '/webapp/styles.css',
    '/webapp/pwa.js',
    ...
    '/webapp/js/cardback.js',
    '/webapp/js/sandbox.js',
    '/webapp/js/cardrefs.js',
    '/webapp/js/replay.js',
    '/webapp/js/replayview.js',
    '/webapp/js/replaysnapshot.js',
    '/webapp/js/helpers.js',
    '/webapp/js/api.js',
    '/webapp/js/p2p.js',
    '/webapp/js/qr.js',
    '/webapp/js/mentalpoker.js',
    '/webapp/js/state.js',
    '/webapp/js/dom.js',
    '/webapp/js/elo.js',
    '/webapp/js/peek.js',
