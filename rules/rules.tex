...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.30\textwidth]{images/Volatile Alchemist.png}}
...
\begin{figure}[ht]
    \centerline{\includegraphics[width=0.1\textwidth]{images/2player.pdf}}
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.4\textwidth]{images/ffa_small.pdf}}
...
\end{figure}
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.4\textwidth]{images/ffa_big.pdf}}
...
\label{subsec:team}
\begin{figure}[hb]
  \centerline{\includegraphics[height=0.1\textwidth]{images/2v2.pdf}}
  \caption{Setup for a 2vs2 team game. The highlighted center location is playable by all players and is worth more.}
  \label{fig:2v2Setup}
\end{figure}
\begin{figure}[hb]
  \centerline{\includegraphics[width=0.15\textwidth]{images/3v3.pdf}}
...
\end{figure}
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.25\textwidth]{images/2v2v2.pdf}}
...
\textbf{Owner} The player whose deck a card came from. Ownership never changes: whenever a card leaves the battlefield it goes to its owner's graveyard, hand or deck, no matter who was commanding it.\\
\textbf{Controller} The player whose creature stack a card is standing on. Gaining control of a creature or gifting one away changes its controller, and every \emph{you}, \emph{your} and \emph{friendly} printed on a card is read from its current controller --- including \emph{your graveyard} in a power calculation. A creature that changed sides therefore fights for its new controller, counts towards their location power, and is no longer a legal target for effects that ask for one of its owner's creatures.\\
...
\textbf{Move a creature} Select a creature and move it on top of the creature stack of another location accessible to the creature's controller.\\
